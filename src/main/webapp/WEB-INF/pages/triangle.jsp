...
<t:template>
  <sec:authorize access="isAuthenticated()">
    <form:form method="get" action="triangle" var="pn">
      <a href="<c:url value="/"/>">Главная</a>

      <h1 id="header">Рассчёт треугольника (вальмы) для вальмовой кровли</h1>
      <table>
        <div id="nav">
          <ol>
            <li>
        ...
        <img style="width: 320px; height: 270px" src="${pageContext.request.contextPath}/resources/img/valma1.jpg">
        ...
        <div id="section">
          ...
          <tr>
            <td>
              <form><label path="h">Высота (h) </label></form></td>
            <td>  <input style="width: 60px" type="text" name="h" value="${h}"/></td>
        </div>

        <div>
          <tr><td><form><label path="base_b"> Полезная ширина листа </label></form></td>
            <td><input style="width: 60px" type="text" name="base_b" value="${pn.base_b}"/></td>
          </tr>
          <tr>
            <td> <form><label path="work_b"> Общая ширина листа </label></form></td>

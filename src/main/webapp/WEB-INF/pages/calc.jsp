...
<t:template>
    <sec:authorize access="isAuthenticated()">
        <form:form method="get" action="calc" var="pn">
            ...
            <table>
                <div id="nav">
                    <ol>
                        <li>
                            ...
                            <%--<a href="triangle"><img src="\resources\img\tangle.svg"></a></p>--%>
                        </li>
                        <p>
                        <li>
                        ...
                        <p>
                        <li>
                            <div id="trapezium"><a href="trapezium.jsp">Трапеция</a></div>
                        </li>
                        </p>
                        <p>
                        <li>
                ...
                <img width="300" height="200" style="right: 500px" src="\resources\img\tangle.svg">
